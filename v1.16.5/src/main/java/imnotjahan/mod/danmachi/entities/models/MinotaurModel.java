...
public class MinotaurModel extends BipedModel<Minotaur>
{
    ...
    public MinotaurModel(float size)
    {
        super(size);
    ...
    //sadly copy this every time and then add in the extra parts
    ...
    private void poseRightArm(Minotaur p_241654_1_) {
    ...
    private void poseLeftArm(Minotaur p_241655_1_) {
