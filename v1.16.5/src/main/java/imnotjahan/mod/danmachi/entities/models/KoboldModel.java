...
public class KoboldModel<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead
{
    ...
    public KoboldModel.ArmPose leftArmPose = KoboldModel.ArmPose.EMPTY;
    public KoboldModel.ArmPose rightArmPose = KoboldModel.ArmPose.EMPTY;
    public boolean crouching;
    public float swimAmount;

    public KoboldModel(float p_i1148_1_)
    {
        this(RenderType::entityCutoutNoCull, p_i1148_1_, 0.0F, 64, 32);
    }

    protected KoboldModel(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_)
    {
        this(RenderType::entityCutoutNoCull, p_i1149_1_, p_i1149_2_, p_i1149_3_, p_i1149_4_);
    }

    public KoboldModel(Function<ResourceLocation, RenderType> p_i225946_1_, float p_i225946_2_, float p_i225946_3_, int p_i225946_4_, int p_i225946_5_)
    {
        super(p_i225946_1_, true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F);
        this.texWidth = p_i225946_4_;
        this.texHeight = p_i225946_5_;
        this.head = new ModelRenderer(this, 0, 0);
        this.head.addBox(-3.0F, -6.0F, -3.0F, 6, 6, 6, p_i225946_2_);
    ...
    public void copyPropertiesTo(KoboldModel<T> p_217148_1_)
    {
