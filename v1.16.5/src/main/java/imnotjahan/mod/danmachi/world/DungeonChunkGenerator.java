...
{
    public static final Codec<DungeonChunkGenerator> CODEC = FlatGenerationSettings.CODEC.fieldOf("settings").xmap(DungeonChunkGenerator::new, DungeonChunkGenerator::settings).codec();
    private final FlatGenerationSettings settings;

    static
    {
        Registry.register(Registry.CHUNK_GENERATOR, new ResourceLocation("danmachi", "dungeon"), CODEC);
    }
