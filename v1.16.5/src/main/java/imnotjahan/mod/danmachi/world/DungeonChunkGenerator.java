...
public class DungeonChunkGenerator extends ChunkGenerator
{
    static
    {
        Registry.register(Registry.CHUNK_GENERATOR, "dungeon", DungeonChunkGenerator.CODEC);
    }

    public static final Codec<DungeonChunkGenerator> CODEC = RecordCodecBuilder.create((p_236091_0_) -> {
    ...
    public DungeonChunkGenerator(BiomeProvider p_i241975_1_, long p_i241975_2_, Supplier<DimensionSettings> p_i241975_4_) {
        this(p_i241975_1_, p_i241975_1_, p_i241975_2_, p_i241975_4_);
    }

    private DungeonChunkGenerator(BiomeProvider p_i241976_1_, BiomeProvider p_i241976_2_, long p_i241976_3_, Supplier<DimensionSettings> p_i241976_5_) {
        ...
        this.minLimitPerlinNoise = new OctavesNoiseGenerator(this.random, IntStream.rangeClosed(-50, 0));
        this.maxLimitPerlinNoise = new OctavesNoiseGenerator(this.random, IntStream.rangeClosed(-50, 0));
    ...
    public ChunkGenerator withSeed(long p_230349_1_) {
        return new DungeonChunkGenerator(this.biomeSource.withSeed(p_230349_1_), p_230349_1_, this.settings);
    }
