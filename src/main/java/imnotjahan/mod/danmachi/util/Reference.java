...
public class Reference
{
    ...
    //entity IDs
    public static final int GOBLIN_ID = 120;
    public static final int KOBOLD_ID = 121;
    public static final int JACK_BIRD = 122;
    public static final int DUNGEON_LIZARD = 123;
    public static final int FROG_SHOOTER = 124;
    public static final int WAR_SHADOW = 125;
    public static final int KILLER_ANT = 126;
    public static final int UNICORN = 127;
    public static final int ALMIRAJ = 128;
