...
public class ModelInfantDragon extends ModelBase
{
    ...
    public ModelInfantDragon(float p_i46360_1_)
    {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityInfantDragon entitydragon = (EntityInfantDragon) entityIn;
        float f = 1 * this.partialTicks;
        ...
        this.head.rotateAngleX = this.updateRotations((double)0 * 0.017453292F * 1.5F * 5.0F);
