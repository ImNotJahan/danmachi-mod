...
public class EntityMetalRabbit extends EntityRabbit
{
    public EntityMetalRabbit(World worldIn)
    {
        super(worldIn);
    ...
    private static final String name = "metal_rabbit";
    @Override
    ...
    {
        return LootTableHandler.mobDrops.get("metal_rabbit");
    }
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if(cause.getTrueSource() instanceof EntityPlayer)
        {
            ...
            for(int k = 0; k < 5; k++)
            {
                status.increase(ModConfig.statusIncreases.get("metal_rabbit")[k], k + 1);
            }

            status.increase(ModConfig.statusIncreases.get("metal_rabbit")[5], 7);
    ...
    protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
    {
        ...
        {
            ResourceLocation resource = LootTableHandler.magicStones.get("metal_rabbit");
